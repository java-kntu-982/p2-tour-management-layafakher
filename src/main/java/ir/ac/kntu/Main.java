...
//        cities.add("Shiraz");cities.add("Isfahan");cities.add("Mashhad");cities.add("Tabriz");cities.add("Tehran");
        ...
        InlandTour inlandTour=new InlandTour("120",200,4,new Date(1399,5,4),place11,place7,20,100,visitedPlaces);
        InlandTour inlandTour1=new InlandTour("121",180,4,new Date(1399,2,3),place11,place8,30,100,strings);
        InlandTour inlandTour2=new InlandTour("122",250,5,new Date(1399,6,8),place11,place9,50,200,strings1);
        InlandTour inlandTour3=new InlandTour("123",250,5,new Date(1399,6,8),place11,place10,20,100,strings2);
        ...
        ForeignTour foreignTour=new ForeignTour("220",500,new Date(1399,2,15),7,place11,place,places1,30,150);
        ForeignTour foreignTour1=new ForeignTour("221",400,new Date(1399,3,11),6,place11,place3,places2,25,170);
        ArrayList<ForeignTour>foreignTours=new ArrayList<>();
        foreignTours.add(foreignTour);foreignTours.add(foreignTour1);
        Scanner scanner1=new Scanner(System.in);
        while (true){
            System.out.println("Press 1 to see tour leaser menu:");
